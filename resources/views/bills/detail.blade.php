        ...
        <div class="">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="sect-1 mb-10">
                        <h2 class="font-bold text-lg">Bill's Information</h2>
                        <hr class="mb-5">
                        ...
                        <div class="flex">
                            ...
                            <div class="w-1/2">
                                <table class="text-sm">
                                    <tbody>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">Billing Period</td>
                                            <td class="pr-5 pb-3">:</td>
                                            <td class="pb-3">{{ $bill->billing_period }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">Amount</td>
                                            <td class="pr-5 pb-3">:</td>
                                            <td class="pb-3">{{ rupiah($bill->amount) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">Status</td>
                                            <td class="pr-5 pb-3">:</td>
                                            <td class="pb-3">
                                                <span
                                        ...
                                        <tr>
                                            <td class="font-semibold pr-10 pb-5">Escalation Status</td>
                                            ...
                                            <td class="pb-5">
                                                @switch($bill->escalation_status)
                                                    ...
                                                    @case('escalated')
                                                        <span
                                                            class="bg-red-100 text-red-500 font-semibold py-1 px-2 rounded-md">
                                                            {{ titleCase($bill->escalation_status) }}
                                                        </span>
                                                    @break
                                                    ...
                                                    @default
                                                        <span
                                                            class="bg-gray-100 text-gray-700 font-semibold py-1 px-2 rounded-md">
                                                            {{ titleCase($bill->escalation_status) }}
                                                        </span>
                                                @endswitch
                                            </td>
                                        ...
                                        @if ($bill->escalation_status === 'escalated')
                                            <tr>
                                                <td class="font-semibold pr-10 pb-2">Escalation Notes</td>
                                                <td class="pr-5">:</td>
                                                <td>
                            ...
                            <div class="w-1/2">
                                <table class="text-sm">
                                    <tbody>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">Student's Name</td>
                                            <td class="pr-5 pb-3">:</td>
                                            <td class="pb-3">{{ $bill->student->name }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">NIS</td>
                                            <td class="pr-5 pb-3">:</td>
                                            <td class="pb-3">{{ $bill->student->nis }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">Class</td>
                                            <td class="pr-5 pb-3">:</td>
                                            <td class="pb-3">{{ $bill->student->class }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-semibold pr-10 pb-3">Parent's Phone</td>
                                            <td class="pr-5 pb-3">:</td>
