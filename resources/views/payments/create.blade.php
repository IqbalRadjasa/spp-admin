                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-3">
                        <div class="input-group">
                            ...
                            <div class="flex gap-4 mt-1">
                                ...
                                <x-form.radio id="transfer" name="payment_method_id" label="Transfer" value="2"
                                    :checked="old('payment_method_id') == 2" />
                            </div>
                        ...
                        <div class="input-group">
                            ...
                            <x-form.text-input id="paid_at" class="mt-1 w-full" type="datetime-local" name="paid_at"
                                :value="old('paid_at')" required autofocus autocomplete="paid_at" />
